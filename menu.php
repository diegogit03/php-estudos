<nav class="modulos">
    ...
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=tratamento_erro&file=gerenciador_erros">
                    Error handler
                </a>
            </li>
        </ul>
    ...
    <div class="modulo laranja-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=namespaces&file=sub_namespaces">
                    Sub namespaces
                </a>
            </li>
            <li>
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=magics_methods">
                    Metodos Magicos
                </a>
            </li>
            <li>
